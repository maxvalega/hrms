...
Route::group(['middleware' => ['verified']], function () {
    ...
    // auth+XSS only here — permission is enforced inside the controller (avoids AJAX 500
    ...
    Route::post('leave/award-compensatory', [LeaveController::class, 'storeAwardCompensatoryLeave'])->name('leave.award.compensatory.store')->middleware(['auth', 'XSS']);
